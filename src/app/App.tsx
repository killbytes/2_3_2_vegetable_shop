...
import ThemeProvider from '../app/providers/ThemeProvider'; // Импортируем провайдер
import ThemeComponent from '../components/Theme/ThemeComponent'; // Компонент, использующий контекст
